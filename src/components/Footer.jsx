...
const Footer = () => {
    return (
        <>
            <div className="bg-[#2E2024] text-white py-8 px-4 text-center justify-evenly">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li className='flex justify-evenly'>
                                <a href="#" className="hover:text-gray-400 flex row">
                                    <div className="">
                                        Solutions
                                    </div>
                                    <div className="bg-white text-[#2E2024] w-10 border-r-4 items-center text-center rounded-[2rem] mx-2">New</div>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><a href="#" className="hover:text-gray-400">AngelList</a></li>
